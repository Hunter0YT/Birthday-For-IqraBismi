...
A beautiful, interactive mini website I built to celebrate my 2nd order friend's girlfriend’s special day ❤️.  
...
1. Clone the repo:  
   ```bash
   https://github.com/Velmuru-Tempest/Birthday-For-Umar.git
